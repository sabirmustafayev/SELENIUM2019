...
//  we have: id, name, tag name, class name, link text, partial link text, xpath, css selector
    ...
    public void test1(){
        ...
        Assert.assertFalse(checkbox1.isSelected(),"Checkbox1 was not sellected");//assert that checkbox is not selected

        //[index] - to specify index of the element, if there are multiple elements with this xpath
        WebElement checkbox2 = driver.findElement(By.xpath("//input[@type='checkbox'][2]"));
        Assert.assertFalse(checkbox1.isSelected(),"Checkbox2 was not sellected");
